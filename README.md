...
[changelog](changelog.md#version-2013)
...
<!-- bs-calendar via jsDelivr (version 2.0.13) -->
<script src="https://cdn.jsdelivr.net/gh/ThomasDev-de/bs-calendar@2.0.13/dist/bs-calendar.min.js"></script>
<script>
    $(function () {
        $('#calendar').bsCalendar();
    });
